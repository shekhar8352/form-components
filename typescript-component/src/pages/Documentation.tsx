      ...
      <Stack gap="xl">
        <div>
          ...
          <Text size="lg" c="dimmed">
            Comprehensive guide to using the Reusable Form Components library with TypeScript
          </Text>
        </div>
        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder>
          ...
          <Text size="sm" c="dimmed" mb="md">
            Learn how to install and set up the component library in your TypeScript project
          </Text>
          <Group gap="xs">
            <Anchor href="#installation" size="sm">Installation</Anchor>
            <Anchor href="#quick-start" size="sm">Quick Start</Anchor>
            <Anchor href="#typescript-setup" size="sm">TypeScript Configuration</Anchor>
          </Group>
        </Card>
        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder>
          ...
          <Text size="sm" c="dimmed" mb="md">
            Explore all available form components with TypeScript examples and type definitions
          </Text>
          <Group gap="xs">
        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder>
          <Group justify="space-between" mb="xs">
            <Group gap="xs">
              <IconCode size={20} />
              <Text fw={500}>TypeScript Examples</Text>
            </Group>
          ...
          <Text size="sm" c="dimmed" mb="md">
            TypeScript-specific examples with full type safety and IntelliSense support
          </Text>
          <Group gap="xs">
            <Anchor href="#typed-forms" size="sm">Typed Forms</Anchor>
            <Anchor href="#interface-definitions" size="sm">Interface Definitions</Anchor>
            <Anchor href="#generic-components" size="sm">Generic Components</Anchor>
          </Group>
        </Card>
        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder>
          ...
          <Group gap="xs">
            ...
            <Anchor href="#typescript-interfaces" size="sm">TypeScript Interfaces</Anchor>
