...
const validationSchema = Yup.object<RegistrationFormValues>({
...
const validationSchema = Yup.object<ContactFormValues>({
  ...
  attachments: Yup.array<File>().of(Yup.mixed<File>())
});
...
function ContactForm() {
  ...
  const examples: Example[] = [
    {
      ...
      description: 'Complete user registration with TypeScript validation',
      code: registrationFormCode,
      components: ['FormTextInput', 'FormDatePicker', 'FormStaticSelect', 'FormYesNoSelect', 'FormTextArea']
    },
    {
      title: 'Contact Form',
      description: 'Contact form with file upload and typed priority selection',
  ...
  return (
    <Container size="lg" py="xl">
      <Stack gap="xl">
        <div>
          <Title order={1} mb="md">TypeScript Examples</Title>
          <Text size="lg" c="dimmed">
            Real-world form implementations with full TypeScript support and type safety
          </Text>
        </div>
        ...
        <Tabs defaultValue="forms" variant="outline">
          ...
          <Tabs.Panel value="patterns" pt="xl">
            <Card shadow="sm" padding="xl" radius="md" withBorder>
              <Title order={3} mb="md">TypeScript Patterns</Title>
              <Text c="dimmed" mb="lg">
                Advanced TypeScript patterns, generic forms, and type-safe validation schemas.
              </Text>
              <Text size="sm" c="blue">
                Coming soon: Generic form components, advanced type patterns, and custom validation types
              </Text>
            </Card>
          </Tabs.Panel>
          ...
          <Tabs.Panel value="styling" pt="xl">
            <Card shadow="sm" padding="xl" radius="md" withBorder>
              <Title order={3} mb="md">TypeScript Styling Examples</Title>
              <Text c="dimmed" mb="lg">
                Type-safe styling with custom themes, typed CSS-in-JS, and component customization.
              </Text>
              <Text size="sm" c="blue">
                Coming soon: Typed theme examples, CSS-in-JS patterns, and component extension patterns
              </Text>
            </Card>
          </Tabs.Panel>
        </Tabs>
