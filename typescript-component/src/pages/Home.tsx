...
function Home() {
  const features: Feature[] = [
    ...
    },
    {
      ...
      description: 'Complete type safety with comprehensive interfaces and IntelliSense',
    },
  ];
  ...
  const quickStats: QuickStat[] = [
    ...
    { label: 'Type Coverage', value: '100%', color: 'orange' },
      ...
      <Stack gap="xl">
        ...
        <div>
          <Title order={2} ta="center" mb="xl">
            Why Choose Our TypeScript Components?
          </Title>
        ...
        <Card shadow="sm" padding="xl" radius="md" withBorder>
          <Title order={3} mb="md">TypeScript Benefits</Title>
          <Text c="dimmed" mb="lg">
            Experience the full power of TypeScript with our component library:
          </Text>
          <SimpleGrid cols={{ base: 1, sm: 2, md: 3 }} spacing="md">
            <List spacing="xs" size="sm" icon={<IconCheck size={16} color="green" />}>
              <List.Item>Full Type Safety</List.Item>
              <List.Item>IntelliSense Support</List.Item>
              <List.Item>Compile-time Validation</List.Item>
            </List>
            <List spacing="xs" size="sm" icon={<IconCheck size={16} color="green" />}>
              <List.Item>Generic Form Values</List.Item>
              <List.Item>Strict Prop Validation</List.Item>
              <List.Item>Auto-completion</List.Item>
            </List>
            <List spacing="xs" size="sm" icon={<IconCheck size={16} color="green" />}>
              <List.Item>Error Prevention</List.Item>
              <List.Item>Better Refactoring</List.Item>
        ...
        <Card shadow="sm" padding="xl" radius="md" withBorder>
          ...
          <Text c="dimmed" mb="lg">
            Our library includes 9 carefully crafted form components, each with full TypeScript support:
          </Text>
          <SimpleGrid cols={{ base: 1, sm: 2, md: 3 }} spacing="md">
            <List spacing="xs" size="sm" icon={<IconCheck size={16} color="green" />}>
        ...
        <Card shadow="sm" padding="xl" radius="md" withBorder style={{ textAlign: 'center' }}>
          ...
          <Text c="dimmed" mb="lg">
            Install the library and start building type-safe forms in minutes
          </Text>
          <Group justify="center" gap="md">
            <Button
              component={Link}
